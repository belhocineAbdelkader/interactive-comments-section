...
function addComment(container, input) {
    ...
    scheduler.postTask(function () { return commentsSection === null || commentsSection === void 0 ? void 0 : commentsSection.insertAdjacentElement("beforeend", newComment); }, { priority: 'user-blocking' });
